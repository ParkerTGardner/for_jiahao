...
//what is the def of genDau_pt, genJetPt
            ...
            for(int kjet=0; kjet < genJetPt->size(); kjet++){
                ...
                for(int  A_trk=0; A_trk < NNtrk1; A_trk++ ){
                    ...
                    if ((jet_dau_eta>0.86) && (jet_dau_eta<2.40)){
                    ...
                    else if ((jet_dau_eta>2.40) && (jet_dau_eta<5.00)){
                    ...
                    //if((*chargedMultiplicity)[indicesR[kjet]] >= trackbinbounds[i] && (*chargedMultiplicity)[indicesR[kjet]] < trackbinboundsUpper[i]){
                        if(tkBool[i] == 1){
                            if (jet_dau_eta>0.86 && jet_dau_eta<2.40) hPhiDrawA[i]->Fill(phi);
                            if (jet_dau_eta>2.40 && jet_dau_eta<5.00) hPhiDrawT[i]->Fill(phi);
                        }
                    }
...
//what is the def of genDau_pt, genJetPt
            ...
            for(int kjet=0; kjet < genJetPt->size(); kjet++){
                ...
                for(int  A_trk=0; A_trk < NNtrk1; A_trk++ ){
                    ...
                    if (jet_dau_eta>2.40 && jet_dau_eta<5.00){
