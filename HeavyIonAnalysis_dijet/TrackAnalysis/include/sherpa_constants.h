...
const int mm = 100;
double   trackbinEdge[trackbin+1]         = {0.0 ,30.0,40.0,50.0,58.0,66.0,75.0,100.0};
const int   trackbinbounds[trackbin]         = {0 ,30,40,50,58,66,75};
const int   trackbinboundsUpper[trackbin]    = {30,40,50,58,66,75,mm};
