...
const int   ktbin = 8;
const int ptbin = 7;
const float ptbinbounds_lo[ptbin] = {0.3,0.7,1.0,1.5,2.0,2.5, 0.3};
const float ptbinbounds_hi[ptbin] = {0.7,1.0,1.5,2.0,2.5,3.0, 3.0};
const int mm = 1000;
const int   trackbinbounds[trackbin]         = {0 ,0 ,25,35,60,65};
const int   trackbinboundsUpper[trackbin]    = {mm,25,35,60,65,mm};
