...
const int   ktbin = 8;
const int ptbin =4;
const float ptbinbounds_lo[ptbin] = {1.0,1.5,2.0,2.5};
const float ptbinbounds_hi[ptbin] = {1.5,2.0,2.5,3.0};
const int mm = 1000;
const int   trackbinbounds[trackbin]         = {0 ,0 ,30,40,50,60,66,75};
const int   trackbinboundsUpper[trackbin]    = {mm,30,40,50,60,66,75,mm};
